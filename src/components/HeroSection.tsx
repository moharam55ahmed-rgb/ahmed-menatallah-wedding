    ...
    >
      ...
      <div className="hidden sm:flex flex-col items-center justify-center w-full h-full max-w-[620px] lg:max-w-[660px] mx-auto z-10 py-1 md:py-2">
        ...
        >
          ...
          {/* Bottom Group: Event Details 3 Cards - Raised UP with bottom margin */}
          <div id="event-details" className="relative z-10 w-full pt-1 pb-1 mb-8 md:mb-12 lg:mb-14 flex flex-col items-center text-center">
