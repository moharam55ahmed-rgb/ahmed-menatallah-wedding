    ...
    >
      ...
      <div className="block sm:hidden w-full h-full max-w-[400px] mx-auto z-10">
        ...
        >
            ...
            <div className="mb-2 text-[#C5A059] flex items-center justify-center gap-2">
              ...
              <svg width="26" height="26" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g transform="translate(20, 20)">
                  ...
                  <path d="M9 0 C5 -2.5, 2 -2.5, 0 0 C2.5 2, 5 2.5, 9 0 Z" fill="#C5A059" opacity="0.9" />
                </g>
              </svg>
          ...
          {/* Middle Group: Event Summary Lines - Clean without background or border */}
          <div className="relative z-10 w-full max-w-[325px] xs:max-w-[345px] space-y-2 text-sm font-cairo text-[#2A1F18] my-0">
          ...
          {/* Bottom Group: Countdown Section + Down Chevron - Elevated to show flowers */}
          <div className="relative z-10 w-full flex flex-col items-center mb-12 xs:mb-14 sm:mb-16">
