...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          1. MOBILE VERSION (Matches Screenshot Exactly)
          Uses high-res empty background: /images/hero-bg-mobile.jpg
          Builds sharp, unblurred vector text & cards on top
          ═══════════════════════════════════════════════════════════════════ */}
      <div className="block sm:hidden w-full max-w-[380px] mx-auto z-10">
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="relative w-full rounded-[28px] border-[1.5px] border-[#D8C29D]/70 shadow-[0_16px_40px_rgba(46,35,28,0.1)] pt-10 pb-8 px-4 flex flex-col items-center text-center overflow-hidden"
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              sizes="100vw"
            />
            {/* Subtle central glow for text clarity while preserving flowers & arch */}
            <div
              className="absolute inset-0"
              style={{
                background: "radial-gradient(ellipse at 50% 38%, rgba(255,253,249,0.85) 0%, rgba(253,250,244,0.50) 60%, rgba(248,242,230,0.15) 100%)",
              }}
            />
          </div>

          {/* Top Golden Islamic Rosette */}
          <div className="relative z-10 mb-2.5 text-[#C5A059] flex items-center justify-center gap-2">
          ...
          {/* Eyebrow Text */}
          <p className="relative z-10 text-xs sm:text-sm font-cairo font-semibold text-[#4A3525] tracking-wide mb-1.5">
            يسرنا دعوتكم لحضور حفل زفاف
          </p>

          {/* Couple Names (Large bold calligraphy) */}
          <h1 className="relative z-10 text-4xl xs:text-[46px] font-ruqaa font-bold text-[#24150C] leading-[1.25] my-1 flex items-center justify-center gap-2">
          ...
          {/* Date below names */}
          <p className="relative z-10 text-sm xs:text-base font-cairo font-bold text-[#4A382C] mb-2">
            14 أكتوبر 2026
          </p>

          {/* Du'aa */}
          <div className="relative z-10 max-w-xs mx-auto mb-4">
            <p className="text-xs xs:text-sm font-amiri font-bold text-[#3A281C] leading-relaxed">
          ...
          {/* Event Summary Card */}
          <div className="relative z-10 w-full max-w-[290px] rounded-2xl bg-[#FFFDF9]/95 border border-[#C5A059]/40 px-4 py-3.5 space-y-2.5 text-xs font-cairo text-[#2A1F18] shadow-[0_4px_16px_rgba(46,35,28,0.06)] backdrop-blur-xs">
            {/* Date */}
            ...
            <div className="flex items-center justify-center gap-1.5 text-center">
              ...
              <div>
                ...
                <p className="text-[10.5px] font-medium text-[#7A6A5D]">شبين القناطر، القليوبية، مصر</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 w-full mt-6 text-center">
            ...
            {mounted && (
              <div className="grid grid-cols-4 gap-2 max-w-[300px] mx-auto" dir="ltr">
                {/* Days */}
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          2. DESKTOP VERSION (Matches Desktop Screenshot Exactly)
          Uses high-res empty background: /images/hero-bg-desktop.jpg
          Builds sharp, unblurred vector text & cards on top
          ═══════════════════════════════════════════════════════════════════ */}
      <div className="hidden sm:flex flex-col items-center w-full max-w-[500px] md:max-w-[520px] mx-auto z-10">
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="relative w-full rounded-[28px] border-[1.5px] border-[#D8C29D]/70 shadow-[0_20px_50px_rgba(46,35,28,0.1)] bg-[#FAF7F2] p-5 sm:p-6 flex flex-col items-center text-center overflow-hidden"
        >
